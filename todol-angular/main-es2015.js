        ...
        if (event.ctrlKey && charCode === 's') {
            ...
            if (this.deepCompare(this.todo, this.todo1)) {
                ...
                if (this.todo1.title !== '' && this.todo.list.length !== 0) {
                    ...
                    this.sendNotification(`TODO list has been updated by ${this.user.userId}`, this.todo.sharedWith.splice(this.todo.sharedWith.indexOf(this.user.userId)));
                }
                else {
                    ...
                    this.sendNotification(`New TODO list has been created by ${this.user.userId}`, this.todo.sharedWith.splice(this.todo.sharedWith.indexOf(this.user.userId)));
                }
