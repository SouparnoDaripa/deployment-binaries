...
const routes = [{ path: 'login', component: _user_login_login_component__WEBPACK_IMPORTED_MODULE_1__["LoginComponent"], pathMatch: 'full' },
...
/* harmony import */ var _todo_todo_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./todo/todo.module */ "./src/app/todo/todo.module.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_6__["NgModule"])({
        ...
        providers: [_services_app_service__WEBPACK_IMPORTED_MODULE_3__["AppService"],
...
AuthFilter.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
];
AuthFilter = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    intercept(req, next) {
        req = req.clone({
            setHeaders: {
                ...
                'Authorization': `${ng2_cookies_ng2_cookies__WEBPACK_IMPORTED_MODULE_1__["Cookie"].get('authToken')}`
            }
        });
...
let AppService = class AppService {
    constructor(http) {
        ...
        this.setUserInfoFromLocalStorage = (data) => {
        ...
        this.getUserTodoList = (createdBy) => {
            return this.http.get(`${this.url}/api/v1/todos/${createdBy}/getAll`);
        };
        this.getUserTodoDetail = (createdBy, todoId) => {
        ...
        this.createNewVersionTodo = (todo) => {
            const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]()
        ...
        this.getUserTodoLastVersion = (userId, parentId, version) => {
            const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]()
                .set('version', version)
...
let SocketService = class SocketService {
    constructor() {
        ...
        this.onReceivingNotification = (userId) => {
            return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"]((observer) => {
    ...
    logout() {
        this.appService.logout().subscribe((apiResponse) => {
            if (apiResponse.status === 200) {
                ng2_cookies_ng2_cookies__WEBPACK_IMPORTED_MODULE_1__["Cookie"].deleteAll(this.router.url);
                localStorage.clear();
...
let SidebarComponent = class SidebarComponent {
    constructor(appService, toastr, modal, socketService) {
        this.appService = appService;
        this.toastr = toastr;
        this.modal = modal;
        this.socketService = socketService;
        this.sendFriendRequest = (senderId, receiver) => {
        ...
        this.acceptFriendRequest = (senderId, receiver) => {
        ...
        this.rejectFriendRequest = (senderId, receiver) => {
...
], SidebarComponent.prototype, "userInfo", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Input"])()
], SidebarComponent.prototype, "userList", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Input"])()
], SidebarComponent.prototype, "friendList", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Input"])()
], SidebarComponent.prototype, "pendingFriendList", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ViewChild"])('modalSendFriendReq', { static: true })
], SidebarComponent.prototype, "modalSendFriendRequest", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ViewChild"])('modalAcceptFriendReq', { static: true })
...
class Item {
    constructor(isSelected, description, children) {
...
class Todo {
    constructor(todoId, title, version, status, list, createdBy, modifiedBy, sharedWith) {
        this.todoId = todoId || '';
        this.title = title || '';
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _components_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/not-found/not-found.component */ "./src/app/shared/components/not-found/not-found.component.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
SharedModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        exports: [
            ...
            _components_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_1__["NotFoundComponent"],
...
/* harmony import */ var src_app_shared_models_item__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/shared/models/item */ "./src/app/shared/models/item.ts");
/* harmony import */ var src_app_shared_models_todo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/shared/models/todo */ "./src/app/shared/models/todo.ts");
...
let DashboardComponent = class DashboardComponent {
    constructor(appService, modal, toastr, socketService) {
        this.appService = appService;
        this.modal = modal;
        this.toastr = toastr;
        this.socketService = socketService;
        ...
        if (event.ctrlKey && charCode === 's') {
            ...
            if (this.deepCompare(this.todo, this.todo1)) {
                ...
                if (this.todo1.title !== '' && this.todo.list.length !== 0) {
                    ...
                    this.fetchUserTodoList(this.user.userId);
                    this.sendNotification(`TODO list has been updated by ${this.user.username}`, this.todo.sharedWith.splice(this.todo.sharedWith.indexOf(this.user.userId)));
                }
                else {
                    ...
                    this.sendNotification(`New TODO list has been created by ${this.user.username}`, this.todo.sharedWith.splice(this.todo.sharedWith.indexOf(this.user.userId)));
                }
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ViewChild"])('modalCreate', { static: true })
], DashboardComponent.prototype, "modalCreate", void 0);
DashboardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: 'app-dasboard',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./dashboard.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/todo/dashboard/dashboard.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./dashboard.component.css */ "./src/app/todo/dashboard/dashboard.component.css")).default]
    })
], DashboardComponent);
...
/* harmony import */ var _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./dashboard/dashboard.component */ "./src/app/todo/dashboard/dashboard.component.ts");
...
const routes = [{ path: 'dashboard/:id', component: _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_5__["DashboardComponent"], canActivate: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_7__["AuthGuard"]] }];
...
/* harmony import */ var src_app_shared_models_user__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/shared/models/user */ "./src/app/shared/models/user.ts");
            ...
            this.appService.login(data).subscribe((apiResponse) => {
                if (apiResponse.status === 200) {
                    ...
                    if (ng2_cookies_ng2_cookies__WEBPACK_IMPORTED_MODULE_5__["Cookie"].get('role') === '2') {
                        ...
                        setTimeout(() => this.goToDashboard(ng2_cookies_ng2_cookies__WEBPACK_IMPORTED_MODULE_5__["Cookie"].get('receiverId')), 1000);
                    }
                }
                else {
                    this.toastr.error(apiResponse.message);
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var ngx_toastr__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ngx-toastr */ "./node_modules/ngx-toastr/fesm2015/ngx-toastr.js");
/* harmony import */ var src_app_shared_models_user__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/shared/models/user */ "./src/app/shared/models/user.ts");
...
/* harmony import */ var _reset_password_reset_password_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./reset-password/reset-password.component */ "./src/app/user/reset-password/reset-password.component.ts");
/* harmony import */ var _auth_auth_filter_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../auth/auth-filter.service */ "./src/app/auth/auth-filter.service.ts");
...
const routes = [{ path: 'signup', component: _signup_signup_component__WEBPACK_IMPORTED_MODULE_3__["SignupComponent"], canActivate: [_auth_auth_filter_service__WEBPACK_IMPORTED_MODULE_11__["AuthFilter"]] },
    { path: 'forgotPassword', component: _forgot_password_forgot_password_component__WEBPACK_IMPORTED_MODULE_9__["ForgotPasswordComponent"], canActivate: [_auth_auth_filter_service__WEBPACK_IMPORTED_MODULE_11__["AuthFilter"]] },
    { path: 'resetPassword', component: _reset_password_reset_password_component__WEBPACK_IMPORTED_MODULE_10__["ResetPasswordComponent"], canActivate: [_auth_auth_filter_service__WEBPACK_IMPORTED_MODULE_11__["AuthFilter"]] }];
...
module.exports = __webpack_require__(/*! D:\Projects\ToDoL\todol-angular\src\main.ts */"./src/main.ts");
